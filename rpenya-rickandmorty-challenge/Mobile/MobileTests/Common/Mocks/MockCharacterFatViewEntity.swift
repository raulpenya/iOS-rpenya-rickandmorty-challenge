...
struct MockCharacterFatViewEntity {
    ...
    static func givenCharacterFat2() -> CharacterFatViewEntity {
        return CharacterFatViewEntity(id: id2, name: name2, status: status2, species: species2, type: type2, gender: gender2, originName: originName2, locationName: locationName2, imageUrl: imageUrl2)
    }
}
